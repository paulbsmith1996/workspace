 ...
 * circle parameterized by the parent component. In 3 dimensions, also holds the
 * planar vector between the parent and child component. An LCompAssoc is used by the 
 * parent component to store information about its children components.  
 */
public class LCompAssoc {
	...
	// The planar vector determined by parent and child components
	private double[] planar;
	
	// This is distance traveled along parameterized curve
	private double t;
	...
	// Get/Set planar vector determined by parent and child components
	public double[] getPlanar() { return planar; }
	public void setPlanar(double[] planar) { this.planar = planar; }
