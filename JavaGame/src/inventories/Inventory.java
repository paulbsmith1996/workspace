...
public class Inventory extends Vector<Pocket> {
	 ...
	 *
	 * @param int
	 *            - Amount to be added or removed from total money
	 */
	...
	/**
	 * Adds an instance of the desired Item to the inventory in the appropriate
	 * pocket
	 *
	 * @pre: item != null
	 ...
	 *
	 * @param Item
	 *            - Item to be removed from the Inventory
	 */
	 ...
	 *
	 * @param pocketName
	 *            - The type of the Pocket being searched, always the same as
	 *            the Item type it holds
	 */
	 ...
	 *
	 * @param Item
	 *            - Item to be searched for in Inventory
	 */
	 ...
	 *
	 * @param String
	 *            - Name of Pocket that needs to be checked for Items
	 */
	...
	/**
	 * Returns a String representation of the Items in Pocket with name
	 * pocketType
	 *
	 * @param String
	 *            - Name of Pocket to be checked
	 */
